    ...
    public class FetchingData
    {
        ...
        public static DataTable GetMiniStatement(int accountNum)
        {
            /*using (SqlConnection con = DBConnection.GetConnection())
            {
                ...
                using (SqlDataReader dataReader = QueryOptimizer.ExecuteReaderFunc("spministatement", "@accNoPara", accountNum))
                {
                    DataTable dt = new DataTable();
        ...
        public static double GetTodayWithdrawedAmount(int accountNum, string date)
        {
            using (SqlConnection con = DBConnection.GetConnection())
            {
